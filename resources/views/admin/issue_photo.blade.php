    ...
    <div class="panel-body">
        <form class="form-horizontal tasi-form" method="post" action="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" class="form-control" placeholder="图片的大标题">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">小标题</label>
                <div class="col-sm-10">
                    <input type="text" name="little_title" class="form-control" placeholder="图片的小标题，可以不写">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="shot_add" class="form-control" placeholder="图片的拍摄地点">
                </div>
            </div>
            <div class="form-group">

$(function () {
    ...
    var isInitMarquee = true;
    var shuffleArray = [];
    var shuffleIndex;
    var autoClearTimer;
    var autoShowTimer;
    var isFirstPlay = localStorage.qplayer == undefined ? true : false;
    var isShuffle = localStorage.qplayer == undefined ? false : localStorage.qplayer === 'true' ? true : false;
